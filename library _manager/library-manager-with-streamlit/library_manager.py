...
# Initialize session state for users and books
...
def library_app():
    ...
    if choice == "ℹ️ About":
        ...
        This app is developed by **AMNA KHAN** to make book management simple and fun!
        """)
    ...
    st.markdown("---")
    st.markdown('<p class="footer">Developed by <strong>AMNA KHAN</strong></p>', unsafe_allow_html=True)
